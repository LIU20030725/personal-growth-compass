...
export const moodPresets: MoodPreset[] = [
  ...
  { id: 'calm', label: '平静', group: 'steady', color: '#b9ded3', face: 'soft' },
  { id: 'relaxed', label: '放松', group: 'steady', color: '#b9ded3', face: 'smile' },
  { id: 'focused', label: '专注', group: 'steady', color: '#b9ded3', face: 'flat' },
  { id: 'clear', label: '清醒', group: 'steady', color: '#a8d3f2', face: 'soft' },
  { id: 'tired', label: '疲惫', group: 'low-energy', color: '#cec4ec', face: 'sleepy' },
  { id: 'bored', label: '无聊', group: 'low-energy', color: '#cec4ec', face: 'flat' },
  { id: 'down', label: '低落', group: 'low-energy', color: '#cec4ec', face: 'sad' },
  { id: 'lonely', label: '孤独', group: 'low-energy', color: '#cec4ec', face: 'sad' },
  ...
  { id: 'sad', label: '悲伤', group: 'low-energy', color: '#cec4ec', face: 'sad' },
