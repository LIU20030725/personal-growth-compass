...
export function EmotionJournalView({ entries, latestToday, onOpen, onFavorite }: {
  ...
  return <div className="emotion-view">
    ...
    {!entries.length ? <div className="emotion-empty-state"><div className="emotion-empty-illustration"><span /><span /><span /></div><h2>今天还没有留下心情</h2><p>哪怕只选一个表情，也是一份完整记录。</p></div> :
